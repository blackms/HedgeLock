...
class KafkaManager:
    ...
    async def publish_confirmation(
        self, confirmation: Dict[str, Any], trace_id: Optional[str] = None
    ) -> None:
    ...
    def is_connected(self) -> bool:
        ...
        consumer_connected = self.consumer is not None and not self.consumer._closed
        producer_connected = (
            self.producer is not None and self.producer._sender.sender_task is not None
        )
