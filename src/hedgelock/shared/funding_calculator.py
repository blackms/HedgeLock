...
from src.hedgelock.shared.funding_models import (
    FundingRate, FundingRegime, FundingContext, FundingSnapshot
)
...
class FundingCalculator:
    ...
    def calculate_funding_context(
        ...
        previous_regime: FundingRegime = None
    ) -> FundingContext:
    ...
    def recommend_action(cls, context: FundingContext) -> Tuple[str, str]:
        ...
        if context.current_regime == FundingRegime.HEATED and context.avg_rate_24h > context.current_rate:
