...
class TestFundingAwareHedging:
    ...
    def test_hedge_decision_with_normal_funding(self, hedger_service, base_risk_message):
    ...
    def test_hedge_decision_with_extreme_funding(self, hedger_service, base_risk_message):
    ...
    def test_hedge_size_too_small_after_adjustment(self, hedger_service, base_risk_message):
    ...
    def test_hedge_size_exceeds_max_after_adjustment(self, hedger_service, base_risk_message):
    ...
    @pytest.mark.asyncio
    async def test_hedge_trade_message_with_funding(self, hedger_service, base_risk_message):
        ...
        hedger_service.bybit_client.place_order = AsyncMock(return_value={
