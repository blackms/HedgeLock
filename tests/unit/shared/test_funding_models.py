...
class TestFundingRate:
    ...
    def test_negative_funding_rate(self):
        ...
        assert abs(rate.annualized_rate - (-21.9)) < 0.01  # -0.02% * 3 * 365
...
class TestFundingSnapshot:
    ...
    def test_avg_rate_24h_empty(self, sample_rates):
        ...
        snapshot = FundingSnapshot(
            symbol="BTCUSDT", current_rate=sample_rates[0], rates_24h=[]
        )
    ...
    def test_max_rate_24h(self, sample_rates):
        ...
        snapshot = FundingSnapshot(
            symbol="BTCUSDT", current_rate=sample_rates[0], rates_24h=sample_rates[:3]
        )
...
class TestKafkaMessages:
    ...
    def test_funding_rate_message(self):
        ...
        message = FundingRateMessage(
            service="collector", funding_rate=rate, trace_id="test-trace-123"
        )
